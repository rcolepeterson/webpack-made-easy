...
I have been playing around with Webpack and have found it to be bad ass and super awesome. The following are some notes and some simple code that other might find useful when getting started.

What is web pack?

Webpack is a module loader that you use to build out applications. Single page or multipage.

Webpack takes your code/styles etc. and converts them to static assets that you can then load using require.

Webpack can do 10,000 more things and gets on the path to discreet, modularized, component based development.
...
4. Add <script src="bundle.js"></script> to index.html (bundle.js will be generated later).
5. Add console.log("hello") in the index.js file.
6. run ...
...
Conclusion: Webpack is bad ass and super cool. The above are just some simple examples of what you can do. I was sold when I figured how easy it was to load code at run time.
